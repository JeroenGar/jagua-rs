...
export const run_lbf_bpp_wasm: (a: any, b: any) => [number, number, number];
export const run_lbf_spp_wasm: (a: any, b: any) => [number, number, number];
export const init_logger_wasm: () => void;
